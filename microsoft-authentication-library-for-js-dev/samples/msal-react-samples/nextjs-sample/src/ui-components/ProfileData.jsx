...
export const ProfileData = ({graphData}) => {
    return (
        <List className="profileData">
            ...
            <UserPrincipalNameItem userPrincipalName={graphData.userPrincipalName} />
        </List>
    );
};
...
const UserPrincipalNameItem = ({ userPrincipalName }) => (
    <ListItem>
        <ListItemAvatar>
            <Avatar>
                <ListItemAvatar />
        ...
        <ListItemText primary="UserPrincipal" secondary={userPrincipalName} />
    </ListItem>
);
